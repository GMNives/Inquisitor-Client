package me.aristhena.client.enemies;
...
public class EnemyManager
{
    ...
    public static void load() {
        ...
        final List<String> fileContent = (List<String>)FileUtils.read(EnemyManager.ENEMY_DIR);
    ...
    public static void save() {
        ...
        FileUtils.write(EnemyManager.ENEMY_DIR, (List)fileContent, true);
    }
}
