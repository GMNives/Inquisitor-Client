...
import me.aristhena.utils.Location;
...
public final class EntityHelper {
    ...
    public static Location predictEntityLocation(Entity e, double milliseconds) {
        if (e != null) {
            if (e.posX == e.lastTickPosX && e.posY == e.lastTickPosY && e.posZ == e.lastTickPosZ) {
                return new Location(e.posX, e.posY, e.posZ, 0, 0);
            }
            double ticks = milliseconds / 1000.0;
            return EntityHelper.interp(new Location(e.lastTickPosX, e.lastTickPosY, e.lastTickPosZ, 0, 0), new Location(e.posX + e.motionX, e.posY + e.motionY, e.posZ + e.motionZ, 0, 0), ticks *= 20.0);
        }
        return null;
    }
    ...
    public static Location interp(Location from, Location to, double pct) {
        ...
        double z = from.getZ() + (to.getZ() - from.getZ()) * pct;
