...
import me.aristhena.utils.EntityHelper;
...
public class BlockHelper {
    ...
    public static EnumFacing getFacing(BlockPos pos) {
        ...
        EnumFacing[] arrayOfEnumFacing1 = orderedValues = new EnumFacing[]{EnumFacing.UP, EnumFacing.NORTH, EnumFacing.EAST, EnumFacing.SOUTH, EnumFacing.WEST, EnumFacing.DOWN};
        int j = orderedValues.length;
        for (int i = 0; i < j; ++i) {
