package me.aristhena.ui.loading;
...
public class SplashProgress {
	...
	public static void drawSplash(TextureManager tm){
		...
		if(splash == null){
			splash = new ResourceLocation("Inquisitor/splash.png");
		}
	...
	private static void drawProgress(){
		...
		Gui.drawRect(0, sr.getScaledHeight() -2, (int)calc, sr.getScaledHeight(), new Color(145, 0, 21).getRGB());
