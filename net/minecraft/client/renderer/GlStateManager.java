...
public class GlStateManager
{
    ...
    public static void bindTexture(final int texture) {
        if (texture != field_179174_p[field_179162_o].field_179059_b) {
            GL11.glBindTexture(3553, field_179174_p[field_179162_o].field_179059_b = texture);
        }
    }
