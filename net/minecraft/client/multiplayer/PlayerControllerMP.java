...
public class PlayerControllerMP
{
    ...
    public ItemStack windowClick(final int windowId, final int slotId, final int mouseButtonClicked, final int p_78753_4_, final EntityPlayer playerIn, final boolean packet) {
        final short var6 = playerIn.openContainer.getNextTransactionID(playerIn.inventory);
        final ItemStack var7 = playerIn.openContainer.slotClick(slotId, mouseButtonClicked, p_78753_4_, playerIn);
        if (packet) {
            this.netClientHandler.addToSendQueue(new C0EPacketClickWindow(windowId, slotId, mouseButtonClicked, p_78753_4_, var7, var6));
        }
        return var7;
    }
