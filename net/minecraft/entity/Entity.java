...
import me.aristhena.client.module.modules.render.ViewClip;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            List var53 = this.worldObj.getCollidingBoundingBoxes(this, getEntityBoundingBox().addCoord(x, y, z));
            ...
            AxisAlignedBB var241;
            for (Iterator var55 = var53.iterator(); var55.hasNext(); z = var241.calculateZOffset(getEntityBoundingBox(), z)) {
              var241 = (AxisAlignedBB)var55.next();
            }
            func_174826_a(getEntityBoundingBox().offset(0.0D, 0.0D, z));
            if ((this.stepHeight > 0.0F) && (var54) && ((var13 != x) || (var17 != z)))
            {
              StepEvent stepEvent = new StepEvent(this.stepHeight, Event.State.PRE);
              ...
              func_174826_a(var21);
              y = this.stepHeight;
              List var30 = this.worldObj.getCollidingBoundingBoxes(this, getEntityBoundingBox().addCoord(var13, y, var17));
              ...
              if (var56 * var56 + var27 * var27 >= x * x + z * z)
              {
                ...
                z = var27;
                func_174826_a(var29);
                if (stepEvent.isActive()) {
                  if ((stepEvent.getStepHeight() > 0.0D) && (var54) && ((var13 != x) || (var17 != z)))
                  {
                    double var561 = x;
                    double var251 = y;
                    double var271 = z;
                    AxisAlignedBB var291 = getEntityBoundingBox();
                    func_174826_a(var21);
                    y = stepEvent.getStepHeight();
                    List var301 = this.worldObj.getCollidingBoundingBoxes(this, getEntityBoundingBox().addCoord(var13, y, var17));
                    AxisAlignedBB var311 = getEntityBoundingBox();
                    ...
                    AxisAlignedBB var691 = getEntityBoundingBox();
                    double var701 = y;
                    ...
                    if (var731 > var481)
                    {
                      x = var671;
                      z = var681;
                      func_174826_a(var311);
                    }
                    else
                    {
                      x = var711;
                      z = var721;
                      func_174826_a(var691);
                    }
                    y = -stepEvent.getStepHeight();
                    AxisAlignedBB var511;
                    for (Iterator var50 = var301.iterator(); var50.hasNext(); y = var511.calculateYOffset(getEntityBoundingBox(), y)) {
                      var511 = (AxisAlignedBB)var50.next();
                    }
//                    func_174826_a(getEntityBoundingBox().offset(0.0D, y + (((StepFantasy)new StepFantasy().getInstance()).packet ? 0.0D : 0.063D), 0.0D));
                    if (var561 * var561 + var271 * var271 >= x * x + z * z)
                    {
                      x = var561;
                      y = var251;
                      z = var271;
                      func_174826_a(var291);
                    }
                    else
                    {
                      new StepEvent(this.stepHeight, Event.State.POST).call();
                    }
                  }
                }
              }
            ...
            this.onGround = (((new Fly().getInstance().isEnabled()) && (this == Minecraft.getMinecraft().thePlayer)) || ((this.isCollidedVertically) && (var15 < 0.0D)));
